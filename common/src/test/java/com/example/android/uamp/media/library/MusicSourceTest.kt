...
class TestMusicSource(
    ...
    override suspend fun load(list: List<JsonMusic>) = Unit
    ...
    override suspend fun updateDataLoad(jsonMusic: JsonMusic, mediaId: String) = Unit

    override suspend fun replaceDataLoad(list: List<JsonMusic>) = Unit
